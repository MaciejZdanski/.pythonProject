...
############################### HELPER FUNCTIONS ###############################
    ...
    def load(self):
        ...
        # Otwarcie pliku walls.txt / tworzenie listy ścian wraz ze współrzędnymi:
...
############################### GAME OVER FUNCTIONS ###############################
    ...
    def game_over_draw(self):
        ...
        self.screen.fill(BLACK)
        quit_text = "Press SPACEBAR button to PLAY AGAIN"
        again_text = "Press ESC button to QUIT"
