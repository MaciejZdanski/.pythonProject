...
class Enemy:
    ...
    def update(self):
        ...
        # ustawienie pozycji siatki w odniesieniu do pix_position
    ...
    def set_colour(self):
        ...
        if self.number == 0: # niebieski
            return (43, 78, 203)
        if self.number == 1: # żółty
            return (197, 200, 27)       
        if self.number == 2: # czerwony
            return (189, 29, 29)   
        if self.number == 3: # pomarańczowy
            return (215, 159, 33)       
